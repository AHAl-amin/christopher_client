...
const AccountAndSettings = () => {
    ...
    return (
        <div className="bg-[#F3F3F3] max-w-7xl mx-auto ">
            {/* Title Section */}
            <div className="mb-6">
                <h1 className="luxury text-[38px] font-semibold text-[#221e1fd7]">Account & Settings</h1>
            ...
            <div className="bg-white border border-[#E5E7EB] rounded-xl p-1.5 flex items-center mb-6 w-full shadow-sm">
                <button
                    ...
                    className={`flex-1 py-3 text-lg font-semibold rounded-lg transition-colors cursor-pointer ${activeTab === 'Account' ? 'bg-[#BCE3E3] text-[#168989]' : 'text-[#64748B] hover:bg-gray-50'
                        }`}
                >
                    Account
                </button>
                <button
                    ...
                    className={`flex-1 py-3 text-lg font-semibold rounded-lg transition-colors cursor-pointer ${activeTab === 'Security' ? 'bg-[#BCE3E3] text-[#168989]' : 'text-[#64748B] hover:bg-gray-50'
                        }`}
                >
                    Security
                </button>
            ...
            {activeTab === 'Account' && (
                <div className="bg-white border border-[#E7E7E7] rounded-3xl p-8 shadow-sm w-full">
                    ...
                    <div className="flex items-center gap-6 mb-8">
                        ...
                        />
                        <button className="flex items-center gap-2 border border-[#D1D5DB] text-[#334155] text-[13px] font-medium px-4 py-2.5 rounded-xl hover:bg-gray-50 transition-colors cursor-pointer">
