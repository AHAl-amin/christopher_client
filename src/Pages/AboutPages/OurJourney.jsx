        ...
        <div className="max-w-7xl mx-auto px-6 xl:px-0  ">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center  mb-16">
             ...
             <div className='flex  items-center '>
                ...
                <h1 className="text-xl md:text-xl  text-[#F68528] mr-4 h1 xl:mt-0 mt-10">Our Journey</h1>
                    <h2 className="lusitana md:text-3xl lg:text-5xl text-2xl font-medium text-[#221E1F] mb-6 leading-normal">
                        Crafting Exceptional Flavor,<br />
                        One Shake at a Time
                    </h2>

                    <p className="text-[#62748E] md:text-xl text-lg leading-relaxed mb-4">
                    ...
                    <p className="text-[#62748E] md:text-xl text-lg leading-relaxed">
