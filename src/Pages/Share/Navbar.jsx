...
const Navbar = () => {
  ...
  return (
    <nav className=" sticky top-0 z-50 ">
      ...
      {/* Sidebar */}
      <div className={`fixed top-12 left-0 md:w-[600px] w-full h-screen bg-white z-50 transform transition-transform duration-300 flex flex-col ${sidebarOpen ? 'xl:translate-x-10 translate-x-0' : '-translate-x-full'}`}>
