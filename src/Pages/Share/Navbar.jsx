...
import GroupOrderModals from '../../components/GroupOrderModals';
...
const Navbar = () => {
  ...
  const { getBucketCount } = useBucket();
  ...
  return (
    <nav className=" sticky top-0 z-50  ">
      ...
      {/* Sidebar */}
      <div className={`fixed top-12 left-0 md:w-[600px] h-fit w-full overflow-y-auto max-h-[90vh]  bg-white z-50 transform transition-transform duration-300 flex flex-col ${sidebarOpen ? 'xl:translate-x-10 translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="flex-1  p-6">
          ...
          <div className="space-y-1">
            {[
              ...
              { label: 'My Rating', path: '/my_rating' },
              ...(isGroupOrderActive ? [{ label: `Group Order  ${groupOrderData.groupName}`, path: '/cart' }] : []),
        ...
        <div className="  py-4">
          <button
            ...
            className="w-full px-4 py-3 text-red-500 hover:bg-red-50 rounded-lg transition flex items-center gap-2"
          >
      ...
      <div className='bg-[#221E1F] hidden md:block md:px-4 '>
      ...
      <div className='bg-[#FFFFFF] xl:px-0 px-4'>
        <div className="container mx-auto flex items-center justify-between py-3 px-6 md:px-0">
          ...
          <div className="flex gap-6">
            ...
            >
              <span className='w-[14px] h-[14px] bg-[#E4002A] text-[#ffff] absolute text-[10px] top-2 rounded-full'>{getBucketCount()}</span>
            ...
            <div className="flex items-center gap-4 text-white ">
              ...
              <div className="flex items-center gap-2">
                <span className="md:text-[14px] text-[10px]">
                  ...
                  {groupOrderData.participantCount} Participants
                </span>
              </div>
            </div>
