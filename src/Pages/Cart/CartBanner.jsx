...
const CartBanner = () => {
    return (
        <div className="relative py-10 overflow-hidden bg-[#F8FBFC] px-4 xl:px-0">
            ...
            <img src="https://res.cloudinary.com/dcpbtzues/image/upload/v1771663741/delicious-berry-cheesecake-slice_2_n3jk1j.png" alt="imge" className="absolute right-0 bottom-0 z-10 lg:opacity-90 opacity-50" />
            ...
            <div className="max-w-7xl mx-auto flex items-center h-full relative z-20 py-4">
                ...
                <div className=''>
                    <div className="space-y-6 max-w-2xl px-6 lg:px-0">
                        ...
                        <p className="text-lg lg:text-[#62748E] leading-relaxed max-w-[37rem]">
